...
use MwsProductApi\Model\GetCompetitivePricingForASINResponse;
use MwsProductApi\Model\GetCompetitivePricingForSKUResponse;
use MwsProductApi\Model\GetLowestOfferListingsForASINResponse;
use MwsProductApi\Model\GetLowestOfferListingsForSKUResponse;
use MwsProductApi\Model\GetMatchingProductResponse;
use MwsProductApi\Model\GetMatchingProductForIdResponse;
use MwsProductApi\Model\GetMyPriceForASINResponse;
use MwsProductApi\Model\GetMyPriceForSKUResponse;
use MwsProductApi\Model\GetProductCategoriesForASINResponse;
use MwsProductApi\Model\GetProductCategoriesForSKUResponse;
use MwsProductApi\Model\GetServiceStatusResponse;
use MwsProductApi\Model\ListMatchingProductsResponse;

class MarketplaceWebServiceProducts_Mock implements MwsProductsInterface {
