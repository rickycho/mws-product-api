...
use RaffW\MwsProductApi\Model\GetMatchingProductRequest;
 ...
 ***********************************************************************/
// @TODO: set request. Action can be passed as GetMatchingProduct
 ...
 * @param mixed                                   $request GetMatchingProduct or array of parameters
 */

function invokeGetMatchingProduct(MwsProductsInterface $service, $request)
{
    try
    {
