...
use RaffW\MwsProductApi\Model\GetProductCategoriesForSKURequest;
 ...
 ***********************************************************************/
// @TODO: set request. Action can be passed as GetProductCategoriesForSKU
$request = new GetProductCategoriesForSKURequest();
 ...
 * @param mixed                                   $request GetProductCategoriesForSKU or array of parameters
 */

function invokeGetProductCategoriesForSKU(MwsProductsInterface $service, $request)
{
    try
    {
