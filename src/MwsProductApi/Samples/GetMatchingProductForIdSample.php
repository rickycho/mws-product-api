...
use RaffW\MwsProductApi\Model\GetMatchingProductForIdRequest;
 ...
 ***********************************************************************/
// @TODO: set request. Action can be passed as GetMatchingProductForId
 ...
 * @param mixed                                   $request GetMatchingProductForId or array of parameters
 */

function invokeGetMatchingProductForId(MwsProductsInterface $service, $request)
{
    try
    {
