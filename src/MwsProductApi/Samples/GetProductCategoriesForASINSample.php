<?php namespace RaffW\MwsProductApi\Samples;
...
use RaffW\MwsProductApi\MwsClient;
use RaffW\MwsProductApi\MwsProductsException;
use RaffW\MwsProductApi\MwsProductsInterface;
use RaffW\MwsProductApi\Model\GetProductCategoriesForASINRequest;
 ...
 ***********************************************************************/
// @TODO: set request. Action can be passed as GetProductCategoriesForASIN
$request = new GetProductCategoriesForASINRequest();
 ...
 * @param mixed                                   $request GetProductCategoriesForASIN or array of parameters
 */

function invokeGetProductCategoriesForASIN(MwsProductsInterface $service, $request)
{
    try
    {
